  ...
  return (
    <div id="guarantee-section" className="w-full flex justify-center px-3 sm:px-5 md:px-6">
      <div className="w-full max-w-xl flex flex-col gap-2 mt-8 px-4 sm:px-8">
        ...
        <p className={`text-base mb-2 ${darkMode ? 'text-[#b5c2c9]' : 'text-[#183b49]'}`}>
        ...
        <p className={`text-sm mb-2 ${darkMode ? 'text-[#b5c2c9]' : 'text-[#183b49]'}`}>
        ...
        <p className={`text-sm mb-3 ${darkMode ? 'text-[#b5c2c9]' : 'text-[#183b49]'}`}>
        ...
        <p className={`text-sm ${darkMode ? 'text-[#b5c2c9]' : 'text-[#183b49]'}`}>
