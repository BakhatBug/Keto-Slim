    ...
    <div className="flex flex-col gap-3">
      ...
      >
        <div className="flex-1 relative">
          <span className="absolute -top-4 -right-16 bg-[#36bc9f] text-[#181a1b] font-bold text-base border-2 border-[#36bc9f] rounded-tr-[10px] rounded-bl-[10px] px-4 py-1 z-10 shadow-[0_2px_8px_rgba(54,188,159,0.1)] tracking-wider">
            23% OFF
          </span>
          ...
          <div
            className={`font-medium text-base mb-6 ${
              darkMode ? 'text-[#b5c2c9]' : 'text-[#183b49]'
            }`}
          >
        ...
        <span className="absolute left-0 right-0 bottom-0 text-[#181a1b] text-xs font-bold px-4 py-1 rounded-b-xl shadow flex justify-center items-center bg-[#36bc9f] tracking-wider border-t border-[#36bc9f] rounded-bl-[10px] rounded-br-[10px] w-full mt-2.5">
          MOST POPULAR
        </span>
      </div>
    </div>
