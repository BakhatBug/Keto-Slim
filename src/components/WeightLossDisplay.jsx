...
function WeightLossDisplay({ formData, onNext, onBack }) {
    ...
    >
      ...
      >
        ...
        >
          You Could Be Losing
          <br />
          <span style={{ color: 'rgb(247, 89, 80)' }}>{WeightLoss} lbs / Week</span>
        </h2>
        <p
...
WeightLossDisplay.propTypes = {
  formData: PropTypes.shape({
    WeightLoss: PropTypes.oneOfType([PropTypes.string, PropTypes.number]).isRequired,
  }).isRequired,
